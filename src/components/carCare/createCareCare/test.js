...
export default class Test extends Component {
 ...
 async getOptions(){
    ...
    const res = await axios.get('https://backendoil.vercel.app/api/carCare/carCare/usage')
    const data = res.data
  ...
  async creatOill (e){
   ...
   await axios.post('https://backendoil.vercel.app/api/carCare/carCare',x).then( () => {
