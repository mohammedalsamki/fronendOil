...
export default class Test extends Component {
 ...
 async getOptions(){
  ...
  async creatOill (e){
    ...
    console.log(x)
   await axios.post('https://backendapioill.herokuapp.com/api/spark/spark',x).then( () => {
    alert("item added")
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Select justifyContent="center" placeholder="originated" options={this.state.selectOptions} onChange={this.handleChange.bind(this)} />
        </Grid>
        <Grid container    style={{  margin: "10px",justifyContent: "space-around"}}>
