...
export default class Test extends Component {
 ...
 async getOptions(){
    ...
    const res = await axios.get('https://backendapioill.herokuapp.com/api/oil/oilUseg')
    const data = res.data
  ...
  async getOptionsoilGrade(){
    ...
    const res = await axios.get(`https://backendapioill.herokuapp.com/api/oil/tours/${this.state.ID}`)
 ...
 async creatOill (e){
   ...
   await axios
    .post('https://backendapioill.herokuapp.com/api/oil', x)
    .then((response) => {
