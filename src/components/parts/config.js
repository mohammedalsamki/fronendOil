window.config = {
    ...
    map: {
      ...
      'devextreme': 'npm:devextreme@21.2.6/cjs',
      'devextreme-react': 'npm:devextreme-react@21.2.6',
      'jszip': 'npm:jszip@3.7.1/dist/jszip.min.js',
      'devextreme-quill': 'npm:devextreme-quill@1.5.12/dist/dx-quill.min.js',
      'devexpress-diagram': 'npm:devexpress-diagram@2.1.47/dist/dx-diagram.js',
      'devexpress-gantt': 'npm:devexpress-gantt@4.0.12/dist/dx-gantt.js',
